        ...
        {selectedProject && (
          <div className="fixed inset-0 z-[999999] flex items-center justify-center p-4 min-h-screen">
            ...
            <motion.div
              ...
              className="relative w-full max-w-5xl bg-white rounded-[3rem] overflow-hidden shadow-[0_100px_150px_rgba(0,0,0,0.6)] z-10 flex flex-col md:flex-row max-h-[85vh] md:max-h-[85vh] border border-white/20"
            >
              <button
                onClick={() => { setSelectedProject(null); setShowInquiry(false); }}
