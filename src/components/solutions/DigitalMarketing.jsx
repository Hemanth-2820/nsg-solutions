    ...
    <div className="min-h-screen bg-white relative overflow-hidden">
      ...
      <div className="max-w-[1200px] mx-auto px-6 py-24">
        <p className="text-xl md:text-2xl text-gray-700 max-w-4xl mx-auto leading-[1.8] text-center font-light">
          Propel your business to the top with our comprehensive Digital Marketing solutions. We build tailored campaigns driving measurable SEO, PPC, and social media growth that converts.
        </p>
      </div>
    </div>
  );
