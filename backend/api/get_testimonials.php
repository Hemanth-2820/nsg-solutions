...
try {
    $stmt = $pdo->query("SELECT id, client_name, client_role, company, content, service_name, rating, created_at FROM testimonials WHERE status = 'approved' ORDER BY created_at DESC");
